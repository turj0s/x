  ...
  return (
    <>
      <link
        ...
        rel="stylesheet"
      />
      <main className="flex h-[960px] justify-center items-start w-full max-w-[1440px] relative bg-white mx-auto my-0 max-md:flex-col max-md:h-auto">
        <div 
          className="flex w-[900px] flex-col justify-end items-center absolute h-[960px] pl-[49px] pr-[442.5px] pt-[863px] pb-12 left-0 top-0 max-md:relative max-md:w-full max-md:h-[400px] max-md:bg-cover max-md:bg-center max-md:pt-80 max-md:pb-5 max-md:px-5 max-sm:h-[300px] max-sm:pt-60 max-sm:pb-[15px] max-sm:px-[15px]"
          style={{
        ...
        <aside className="flex w-[540px] flex-col justify-between items-start absolute h-[960px] box-border p-10 left-[900px] top-0 max-md:relative max-md:w-full max-md:h-auto max-md:p-[30px] max-md:left-0 max-md:top-0 max-sm:p-5">
